...
UUID=${UUID:-'572f0ebe-3502-449a-baa7-3fcf2d590bbf'}
VMESS_WSPATH=${VMESS_WSPATH:-'/572f0ebe-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/572f0ebe-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/572f0ebe-trojan'}
